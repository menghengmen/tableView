...
class SwiftQRCodeVC: UIViewController{
    ...
    override func viewDidLoad(){
        ...
        // 监听屏幕旋转
//        NotificationCenter.default.addObserver(self, selector: #selector(receiverNotification), name: UIDevice.NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
    }
